...
export function Hero({ onGetStarted }: HeroProps) {
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-48">
        <div className="text-center">
          ...
          From bugs to butterflies—share your story, show your vibe, and meet coders who might just hack your heart.
          </p>
          <Button 
            size="lg" 
